        ...
        <div className="home-menu">
          ...
          <div
            ...
            <div id="close-mobile-menu" className="home-close-mobile-menu">
              <svg viewBox="0 0 804.5714285714286 1024" className="home-icon" style={{cursor:'pointer'}}>
...
closeButton.addEventListener("click", function() {
    mobileMenu.style.transform = "translateX(100%)"
        ...
        <header className="home-header">
          <h1 className="home-text010">Take Control of Your Social Media</h1>
          <p className="home-text011">
          
          Maximize online presence with BusinessBrander's tailored Website and social media solutions.
        ...
        <div className="home-dashboard-preview">
          <div className="home-outline">
            <img
              alt="pastedImage"
              src="/add%20a%20heading-1000h.png"
              loading="lazy"
        ...
        <div className="home-cards">
          <div className="home-container03">
            <div className="card">
              ...
              />
              <span className="home-text020">Schedule</span>
              <span className="home-text021">Schedule When To Post</span>
            </div>
            <div className="home-publish card">
              ...
              />
              <span className="home-text022">Publish</span>
              <span className="home-text023">
                Easily upload a month&apos;s worth of images and videos for your
                Social Media
              </span>
            </div>
          </div>
          <div className="home-container04">
            <div className="card home-analyze">
              ...
              />
              <span className="home-text024">Analyze</span>
              <span className="home-text025">
                Gain deep insights into the performance of your websites and
                marketing campaigns with comprehensive analytics.
              </span>
            </div>
            <div className="card">
              <img
              ...
              />
              <span className="home-text026">Get leads</span>
        ...
        <div className="home-quote">
          ...
          <div className="home-author">
            ...
            <span className="home-quote1">
              <span className="home-text028">—  Peter McPau</span>
      ...
      <section className="home-statistics">
        <div className="home-container05">
          <ActiveUsers caption="— Active users" statistic="3"></ActiveUsers>
          <ActiveUsers
            caption="— Accounts Managed"
            statistic="10"
          ></ActiveUsers>
          <ActiveUsers caption="— Posts Scheduled" statistic="70"></ActiveUsers>
        </div>
      </section>
        ...
        <div className="home-banner-manage">
          <div className="home-container06">
            <div className="home-left1">
              ...
              <span className="home-text031 title">
          ...
          <div className="home-centered-container">
            ...
            <div className="home-right1">
              ...
              <div className="home-category1">
                <span className="home-text039">Power reports</span>
                <span className="home-text040">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
                  do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                  vv
                </span>
                <span className="home-text041">Example -&gt;</span>
              </div>
            </div>
          </div>
        </div>
        <div className="home-banner">
          <div className="home-container07">
            <div className="home-left2">
              <span className="home-text042">Improve Scheduling</span>
              <h2 className="home-text043 title">
        ...
        <div className="home-centered-container3">
          <div className="home-heading2">
            ...
            <div className="home-selection">
              ...
              <span className="home-text061 Yearly">Yearly</span>
            </div>
          </div>
      ...
      <section className="home-faq">
        <div className="home-heading4">
          <span className="home-text106 title">Frequently asked questions</span>
